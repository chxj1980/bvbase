...
ALLBVLIBS = bvutil bvdevice bvserver bvconfig bvsystem bvformat bvcodec
...
LDFLAGS    := $(ALLBVLIBS:%=$(LD_PATH)lib%) $(LDFLAGS)
...
BVLIBS    := $($(NAME)_BVLIBS) $(BVLIBS-yes) $(BVLIBS)
TESTPROGS += $(TESTPROGS-yes)

LDLIBS       = $(BVLIBS:%=%$(BUILDSUF))
BVEXTRALIBS := $(LDLIBS:%=$(LD_LIB)) $(EXTRALIBS)
