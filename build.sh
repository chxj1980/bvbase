...
enable_his3535()
{
	...
	EXTRA="--arch=arm"
	EXTCFLAGS+="-march=armv7-a -mcpu=cortex-a9 "
	EXENABLE+="--enable-his3535 "
	EXTCFLAGS+="-I$BVBASE_DIR/hissdk/his3535/include "
	#FIXME
#	EXTLFLAGS+="-L$BVBASE_DIR/hissdk/his3535/lib -lmpi -lhiaudio "
}
...
if [ "$1" != "x86" ];then
	./configure --prefix=$BVBASE_DIR/$NAME/$1 --enable-cross-compile --disable-doc --disable-debug --disable-manpages \
		...
		--disable-asm --disable-yasm --disable-zlib  \
