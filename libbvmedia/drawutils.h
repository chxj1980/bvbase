/*************************************************************************
    > File Name: drawutils.h
    > Author: albertfang
    > Mail: fang.qi@besovideo.com 
    > Created Time: 2015年04月08日 星期三 19时43分32秒
 ************************************************************************/
/*
...
#ifndef BV_MEDIA_DRAW_UTILS_H
#define BV_MEDIA_DRAW_UTILS_H
...
int bv_fill_line_with_color(uint8_t *line[4], int pixel_step[4], int w,
                            uint8_t dst_color[4],
...
typedef struct BVDrawContext {
    const struct BVPixFmtDescriptor *desc;
 ...
 *
 * The coordinates must be as even as the subsampling requires.
 * The color needs to be inited with bv_draw_color.
 */
 ...
 *
 * The flags are the same as bv_draw_init, i.e., none currently.
 */
//BVFilterFormats *bv_draw_supported_pixel_formats(unsigned flags);

#ifdef __cplusplus
}
#endif

#endif /* end of include guard: BV_MEDIA_DRAW_UTILS_H */
