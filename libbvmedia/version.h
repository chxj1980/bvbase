...
#define LIBBVMEDIA_VERSION_INT BV_VERSION_INT(LIBBVMEDIA_VERSION_MAJOR, \
                                               LIBBVMEDIA_VERSION_MINOR, \
                                               LIBBVMEDIA_VERSION_MICRO)
#define LIBBVMEDIA_VERSION     BV_VERSION(LIBBVMEDIA_VERSION_MAJOR, \
                                           LIBBVMEDIA_VERSION_MINOR, \
                                           LIBBVMEDIA_VERSION_MICRO)
#define LIBBVMEDIA_BUILD       LIBBVMEDIA_VERSION_INT

#define LIBBVMEDIA_IDENT       "Lbvmda" BV_STRINGIFY(LIBBVMEDIA_VERSION)
