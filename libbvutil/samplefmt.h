...
#ifndef BVUTIL_SAMPLEFMT_H
#define BVUTIL_SAMPLEFMT_H
 ...
 *
 * - The data layout as used in bv_samples_fill_arrays() and elsewhere in BVBase
 *   (such as BVFrame in libavcodec) is as follows:
 *
 * @par
 ...
 */
enum BVSampleFormat {
    BV_SAMPLE_FMT_NONE = -1,
    BV_SAMPLE_FMT_U8,          ///< unsigned 8 bits
    BV_SAMPLE_FMT_S16,         ///< signed 16 bits
    BV_SAMPLE_FMT_S32,         ///< signed 32 bits
    BV_SAMPLE_FMT_FLT,         ///< float
    BV_SAMPLE_FMT_DBL,         ///< double

    BV_SAMPLE_FMT_U8P,         ///< unsigned 8 bits, planar
    BV_SAMPLE_FMT_S16P,        ///< signed 16 bits, planar
    BV_SAMPLE_FMT_S32P,        ///< signed 32 bits, planar
    BV_SAMPLE_FMT_FLTP,        ///< float, planar
    BV_SAMPLE_FMT_DBLP,        ///< double, planar

    BV_SAMPLE_FMT_NB           ///< Number of sample formats. DO NOT USE if linking dynamically
};
...
/**
 * Return a sample format corresponding to name, or BV_SAMPLE_FMT_NONE
 * on error.
 */
 ...
 * BV_SAMPLE_FMT_NONE on error. If the passed sample_fmt is already in the
 ...
 * (use bv_samples_get_buffer_size() to compute its minimum size),
 ...
 * The allocated samples buffer can be freed by using bv_freep(&audio_data[0])
 ...
 * @see bv_samples_fill_arrays()
 * @see bv_samples_alloc_array_and_samples()
 */
 ...
 *
 * This is the same as bv_samples_alloc(), but also allocates the data
 * pointers array.
 *
 * @see bv_samples_alloc()
 */
