...
#ifndef BVUTIL_OLD_PIX_FMTS_H
#define BVUTIL_OLD_PIX_FMTS_H
 ...
 *
 * Do not add new items to this list. Use the BVPixelFormat enum instead.
 */
    PIX_FMT_NONE = BV_PIX_FMT_NONE,
