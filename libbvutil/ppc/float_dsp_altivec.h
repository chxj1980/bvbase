...
#ifndef BVUTIL_PPC_FLOAT_DSP_ALTIVEC_H
#define BVUTIL_PPC_FLOAT_DSP_ALTIVEC_H

void bb_vector_fmul_altivec(float *dst, const float *src0,
...
#endif /* BVUTIL_PPC_FLOAT_DSP_ALTIVEC_H */
