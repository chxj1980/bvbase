...
#ifndef BVUTIL_IMGUTILS_H
#define BVUTIL_IMGUTILS_H
 ...
 * plane, should be filled by bv_image_fill_linesizes()
 ...
 *
 * bv_image_get_buffer_size() can be used to compute the required size
 ...
 * @return 0 if valid, a negative BVERROR code otherwise
 */
