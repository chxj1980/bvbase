...
#ifndef BVUTIL_FLOAT_DSP_H
#define BVUTIL_FLOAT_DSP_H

#include "config.h"

typedef struct BVFloatDSPContext {
    /**
     ...
     */
    void (*butterflies_float)(float *bv_restrict v1, float *bv_restrict v2, int len);
 ...
 * @param strict  setting to non-zero avoids using functions which may not be IEEE-754 compliant
 */
BVFloatDSPContext *bvpriv_float_dsp_alloc(int strict);

#endif /* BVUTIL_FLOAT_DSP_H */
