...
#ifndef BVUTIL_ATOMIC_SUNCC_H
#define BVUTIL_ATOMIC_SUNCC_H
...
#define bvpriv_atomic_int_get atomic_int_get_suncc
...
#define bvpriv_atomic_int_set atomic_int_set_suncc
...
#define bvpriv_atomic_int_add_and_fetch atomic_int_add_and_fetch_suncc
static inline int atomic_int_add_and_fetch_suncc(volatile int *ptr, int inc)
{
    return atomic_add_int_nv(ptr, inc);
}

#define bvpriv_atomic_ptr_cas atomic_ptr_cas_suncc
