 ...
 */
    ...
    #define BV_DECLARE_ALIGNED(n,t,v)      t __attribute__ ((aligned (n))) v
    #define BV_DECLARE_ASM_CONST(n,t,v)    const t __attribute__ ((aligned (n))) v
#elif defined(__TI_COMPILER_VERSION__)
    #define BV_DECLARE_ALIGNED(n,t,v)                      \
        BV_PRAGMA(DATA_ALIGN(v,n))                      \
        t __attribute__((aligned(n))) v
    #define BV_DECLARE_ASM_CONST(n,t,v)                    \
        BV_PRAGMA(DATA_ALIGN(v,n))                      \
        static const t __attribute__((aligned(n))) v
#elif defined(__GNUC__)
    #define BV_DECLARE_ALIGNED(n,t,v)      t __attribute__ ((aligned (n))) v
    #define BV_DECLARE_ASM_CONST(n,t,v)    static const t bv_used __attribute__ ((aligned (n))) v
#elif defined(_MSC_VER)
    #define BV_DECLARE_ALIGNED(n,t,v)      __declspec(align(n)) t v
    #define BV_DECLARE_ASM_CONST(n,t,v)    __declspec(align(n)) static const t v
#else
    #define BV_DECLARE_ALIGNED(n,t,v)      t v
    #define BV_DECLARE_ASM_CONST(n,t,v)    static const t v
#endif
