...
#ifndef BVUTIL_EVAL_H
#define BVUTIL_EVAL_H
 ...
 * Note, this is significantly slower than bv_expr_eval().
 *
 ...
 */
int bv_expr_parse_and_eval(double *res, const char *s,
 ...
 *
 * @param const_values a zero terminated array of values for the identifiers from bv_expr_parse() const_names
 * @param opaque a pointer which will be passed to all functions from funcs1 and funcs2
