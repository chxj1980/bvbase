...
$(foreach D,$(BVLIBS),$(eval $(call DOSUBDIR,lib$(D))))
...
libbvutil/utils.o : libbvutil/bbversion.h
...
libbvutil/bbversion.h .version:
	$(M)$(VERSION_SH) $(SRC_PATH) libbvutil/bbversion.h $(EXTRA_VERSION)
	$(Q)touch .version
